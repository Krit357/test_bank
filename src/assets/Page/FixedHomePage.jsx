...
const FixedHomePage = () => {
  return (
    <div className="home-page">
      <div>
        <div className="homepage-first-column">
          <div className="homepage-first-column-left">
          ...
          <div className="homepage-first-column-right">
            {/*** DESKTOP SVG (shown when screen > 845px) ***/}
            <svg
            ...
            >
              <defs>
                ...
                <path
                  ...
                  M69.445 572.84
                  L203.73 707.112
                  a100 100 0 0070.708 29.286
                  h70.693
                  a100 100 0 0170.708 29.287
                  l161.04 161.027
                  A100 100 0 00647.584 956
                  h388.853
                  c44.964 0 81.415-36.45 81.415-81.414
                  a81.414 81.414 0 00-23.848-57.57
                  l-86.392-86.386
                  c-12.033-12.032-12.034-31.54-.002-43.574
                  a30.812 30.812 0 0121.788-9.025
                  c17.017 0 30.812-13.795 30.812-30.812
                  0-8.172-3.246-16.01-9.025-21.788
                  L855.85 430.11
                  a100 100 0 00-70.708-29.287
                  H550.7
                  a100 100 0 01-70.708-29.287
                  l-35.253-35.25
                  A100 100 0 00374.032 307
                  H138.88
                  c-31.769 0-57.523 25.754-57.523 57.523
                  a57.523 57.523 0 0016.85 40.676
                  l28.761 28.76
                  c15.886 15.884 15.887 41.64.003 57.525
                  a40.676 40.676 0 01-28.764 11.915
                  c-22.465 0-40.677 18.211-40.677 40.676
                  a40.676 40.676 0 0011.915 28.764
                  z
                "
                />
              </defs>
            ...
            {/*** MOBILE SVG (shown when screen ≤ 845px) ***/}
            <svg
            ...
            >
              ...
              <g fill="none" fillRule="evenodd" transform="translate(-94 -52)">
                <use
                  ...
                  xlinkHref="#b_mobile"
                />
                <use fill="#2D314D" xlinkHref="#b_mobile" />
                <path
                  fill="url(#c_mobile)"
            ...
            <img className="image-mockup" src={imgMockup} alt="mockup" />
          </div>
        </div>
      </div>

      <div className="second-column">
        <div className="second-column-left">
        ...
        <div className="second-column-right">
          <div className="homepage-second-column">
            <svg
              className="icon"
              xmlns="http://www.w3.org/2000/svg"
              width="72"
      ...
      <div className="third-column">
        ...
        <div className="third-column-all-post">
          <div className="third-column-post">
            <div className="third-column-article">
              <img
                className="third-column-image"
                src={currency}
                alt="currency"
              />
              <div className="third-column-text-box">
                <h5 className="third-column-article-post">
                  By Claire Robinson
                </h5>
                <h2 className="third-column-header">
                  Receive money in any currency with no fees
                </h2>
                <p className="third-column-information">
          ...
          <div className="third-column-post">
            <div className="third-column-article">
              ...
              />
              <div className="third-column-text-box">
                <h5 className="third-column-article-post">By Wilson Hutton</h5>
                <h2 className="third-column-header">
          ...
          <div className="third-column-post">
            <div className="third-column-article">
              <img className="third-column-image" src={plane} alt="currency" />
              <div className="third-column-text-box">
                <h5 className="third-column-article-post">By Wilson Hutton</h5>
                <h2 className="third-column-header">
